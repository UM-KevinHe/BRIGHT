#' Quality control 
#'
#' Convert GWAS summary statistics to the marginal correlations. Remove summary statistics markers, which are not in the reference or have NA values. Adjusting the summary statistics sign based on reference alleles.
#'
#' @param ss a data frame of the summary statistics, which needs to match the ind indicator.
#' @param ind a character scalar indicator of the type of ss, it can only takes value of "GWAS", "Corr", or "Coef".
#' @param KG a data frame of the markers information from reference.
#' @param lab a character scalar of the data name being processed. Usually either "target" or "prior" as input.
#' @return The new cleaned summary statistics stored as a data frame.
