...
void gd_gaussiani(double *b, double *x, double *r, int g, int *K1, int *K,
...
SEXP gdfit_gaussiani(SEXP X_, SEXP y_, SEXP penalty_, SEXP K1_, SEXP K0_, 
      ...
      while (tot_iter < max_iter) {
        while (tot_iter < max_iter) {
          ...
          for (int g=0; g<J; g++) {
            ...
            if (e[g]) {
              gd_gaussiani(b, X, r, g, K1, K, n, l, p, penalty, l1, l2, gamma, df, a, &maxChange);
            }
          }
