...
# BRIGHTs with summary-level data: type.trait="quantitative" (Continuous)
...
# BRIGHTi with individual-level data: type.trait="quantitative" (continuous), "qualitative" (binary), or "count" (poisson)
